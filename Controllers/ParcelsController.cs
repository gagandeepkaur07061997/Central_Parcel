...
namespace Central_Parcel.Controllers
{
    public class ParcelsController : Controller
    {
        ...
        public ParcelsController(Central_ParcelDatabase context)
        {
            _context = context;
        }
        ...
        {
            var central_ParcelDatabase = _context.Parcels.Include(p => p.Companies).Include(p => p.Recievers).Include(p => p.Senders);
